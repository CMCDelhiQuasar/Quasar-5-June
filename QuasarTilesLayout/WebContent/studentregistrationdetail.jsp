		...
		<div id="regForm">
			...
			<s:form name="regform" theme="simple" action="registration"
					...
					<s:div id="basicDetails">
						...
						<tr>
							<td><s:label value="Course" labelSeparator=""
									labelposition="left" /></td>
							<td><s:select name="coursename"
									list="%{#{'Select':'Select'}}" label="Course" labelSeparator="">
				...
				<table>
					...
					<s:div>
						<tr>
							<td><s:label value="Number of Installments"
				...
				<table border="0">
					<tr>
						<s:div>
							...
							<td><s:reset value="Reset" cssClass="css_button"
									align="left" /></td>
							<td width="30"></td>
